...
function load() {
	...
	.bootstrapTable(
			{
				...
				url : "/xinshineng/yanke/getUserDetail/"+id, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/yanke/getUserDetail2/"+id, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/yanke/getUserDetail3/"+id, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/yanke/getUserDetail4/"+id, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/yanke/getUserDetail5/"+id, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
