...
function load() {
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : prefix + "/checkList", // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
...
$("#select").click(function(){
	...
	$('#exampleTable').bootstrapTable('refresh',temp);
	$('#exampleTable2').bootstrapTable('refresh',temp);
