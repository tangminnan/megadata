	...
	.bootstrapTable(
			{
				...
				url : "/xinshineng/shaicha/getUserDetail6/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
...
//						endTime:$('#endTime').val()
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/shaicha/getUserDetail4/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/shaicha/getUserDetail5/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/shaicha/getUserDetail8/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/shaicha/getUserDetail1/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/shaicha/getUserDetail/"+id, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
