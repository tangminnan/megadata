...
function load() {
	...
	.bootstrapTable(
			{
				...
				url : "/xinshineng/shaicha/getUserDetail7/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/shaicha/getUserDetail2/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/xinshineng/shaicha/getUserDetail3/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
